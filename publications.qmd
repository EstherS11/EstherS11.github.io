...
::: {.pub-page-item #minority}
![](paper_pics/TBD.png){.pub-page-img}

::: {.pub-page-content}
::: {.pub-tags}
[Interspeech 2026]{.venue .venue-interspeech} [Working on]{.status .status-working}
:::
**Towards Comprehensive Emotional Characterization: Ambiguity-Aware Emotion Reasoning in Speech**

First Author

[Hierarchical Emotion Modeling]{.keyword} · [Cross-Model Distillation]{.keyword} · [Explainable SER]{.keyword}
