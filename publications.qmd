...
- **Agentic Framework:** Developed an autonomous MLLM-based agent capable of dynamic tool-use, programmatically invoking a specialized toolkit of semantic and acoustic probes to analyze paralinguistic cues.
- **Evidence-Grounded Rationalization:** Enables the generation of high-fidelity rationales anchored in physical acoustic evidence—such as pitch trajectories and energy profiles—to mitigate inherent linguistic bias and enhance interpretability.
- **Reinforcement Learning Alignment:** Implemented Group Relative Policy Optimization (GRPO) to align the agent's multi-step reasoning trajectories with human-expert consensus and logical rigor.
- **Ambiguity-Driven Reasoning:** Systematically addresses annotator disagreement by modeling emotional ambiguity through a multi-turn, consensus-driven inquiry process, improving robustness on challenging datasets like MSP-Podcast and IEMOCAP.
:::
:::
:::
:::
