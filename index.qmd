...
::: {.social-links}
[![](icon/google_scholar_icon_130918.webp){.social-icon}Google Scholar](https://scholar.google.com/citations?user=XJFMJkwAAAAJ&hl=en){.social-link}
[![](icon/linkedin.avif){.social-icon}LinkedIn](https://www.linkedin.com/in/esther-sun-591212219/){.social-link}
[![](icon/email.png){.social-icon}Email](mailto:esthers@andrew.cmu.edu){.social-link}
:::
:::
:::
